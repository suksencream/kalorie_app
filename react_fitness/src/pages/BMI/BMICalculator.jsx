    ...
    <div className="container">
      <div className="whitebox">
        ...
        <div className="input-container">
          <div className="input-box">
            ...
            <div className="input-controls">
              ...
              <input className="age" type="text" onChange={(e) => setWeight(e.target.value) } value={weight}></input>
          ...
          <div className="input-box">
            ...
            <div className="input-controls">
              ...
              <input className="age" type="text" onChange={(e) => setAge(e.target.value) } value={age}></input>
        ...
        <div className="height-box">
          <p>Height (cm)</p>
          <input className="height" type="text" onChange={(e) => setHeight(e.target.value) } value={height}></input>
